...
def cargar_instancia():
    ...
    nombre_archivo = 'instancia_100.txt'#sys.argv[1].strip()
...
def correr_experimentos(archivos_instancias, nombre_salida_csv):
    ...
    # Guardar en CSV
    with open(nombre_salida_csv, mode='a', newline='') as file:
...
if __name__ == '__main__':
    m = 30
    archivos = [f'instancia_{i}_30_clientes.txt' for i in range(16,m)]
    correr_experimentos(archivos, 'resultados_experimentos_modelo_nuevo_sin_extra_30clientes.csv')